Pod::Spec.new do |s|
	...
	s.homepage     = "https://github.com/SymonhayMoroz/Calendar"
	s.license      = "MIT"
	s.author       = { "iOS Developer." => "julienmartin@hotmail.com" }
	s.platform     = :ios, "8.0"
	s.source       = { :git => "https://github.com/SymonhayMoroz/Calendar.git", :tag => s.version.to_s }
